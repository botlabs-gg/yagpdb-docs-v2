...
- **Channels** <br> The channels to ignore.
  Select as many as you like. (Default: None)
...
- **Categories** <br> The categories to ignore.
  Select as many as you like. (Default: None)
...
- **Categories** <br> The categories to apply this rule to.
  Select as many as you like. (Default: None)
